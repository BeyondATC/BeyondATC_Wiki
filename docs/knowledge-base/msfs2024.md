...
!!! warning "This page is outdated"
    This page was written for the MSFS 2024 launch and some information may no longer be accurate. To set up BeyondATC with MSFS, follow the [Getting Started guide](../onboarding/getting-started.md).
